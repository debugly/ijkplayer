...
#define FFMPEG_CONFIGURATION "--prefix=/d/Code/ijkplayer/shell/windows/../build/product/windows/ffmpeg-x86 --disable-gpl --disable-nonfree --disable-static --enable-shared --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-avdevice --disable-postproc --disable-avfilter --disable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-encoders --disable-decoders --enable-decoder=aac --enable-decoder=aac_fixed --enable-decoder=aac_at --enable-decoder=aac_latm --enable-decoder=ac3 --enable-decoder=ac3_fixed --enable-decoder=ac3_at --enable-decoder=alac --enable-decoder=alac_at --enable-decoder=amrnb --enable-decoder=amr_nb_at --enable-decoder=libopencore_amrnb --enable-decoder=amrwb --enable-decoder=libopencore_amrwb --enable-decoder=ape --enable-decoder=aptx --enable-decoder=aptx_hd --enable-decoder=atrac1 --enable-decoder=atrac3 --enable-decoder=atrac3al --enable-decoder=on2avc --enable-decoder=binkaudio_dct --enable-decoder=binkaudio_rdft --enable-decoder=bmv_audio --enable-decoder=comfortnoise --enable-decoder=cook --enable-decoder=dolby_e --enable-decoder=dsd_lsbf --enable-decoder=dsd_lsbf_planar --enable-decoder=dsd_msbf --enable-decoder=dsd_msbf_planar --enable-decoder=dsicinaudio --enable-decoder=dss_sp --enable-decoder=dst --enable-decoder=dca --enable-decoder=dvaudio --enable-decoder=eac3 --enable-decoder=eac3_at --enable-decoder=evrc --enable-decoder=flac --enable-decoder=g723_1 --enable-decoder=g729 --enable-decoder=gsm --enable-decoder=gsm_ms --enable-decoder=gsm_ms_at --enable-decoder=iac --enable-decoder=ilbc_at --enable-decoder=imc --enable-decoder=mace3 --enable-decoder=mace6 --enable-decoder=metasound --enable-decoder=mlp --enable-decoder=mp1 --enable-decoder=mp1float --enable-decoder=mp1_at --enable-decoder=mp2 --enable-decoder=mp2float --enable-decoder=mp2_at --enable-decoder=mp3float --enable-decoder=mp3 --enable-decoder=mp3_at --enable-decoder=mp3adufloat --enable-decoder=mp3adu --enable-decoder=mp3on4float --enable-decoder=mp3on4 --enable-decoder=als --enable-decoder=mpc7 --enable-decoder=mpc8 --enable-decoder=nellymoser --enable-decoder=opus --enable-decoder=libopus --enable-decoder=paf_audio --enable-decoder=qcelp --enable-decoder=qdm2 --enable-decoder=qdm2_at --enable-decoder=qdmc --enable-decoder=qdmc_at --enable-decoder=ralf --enable-decoder=s302m --enable-decoder=sbc --enable-decoder=shorten --enable-decoder=sipr --enable-decoder=smackaud --enable-decoder=sonic --enable-decoder=libspeex --enable-decoder=tak --enable-decoder=truehd --enable-decoder=truespeech --enable-decoder=tta --enable-decoder=twinvq --enable-decoder=vmdaudio --enable-decoder=vorbis --enable-decoder=libvorbis --enable-decoder=wavpack --enable-decoder=ws_snd1 --enable-decoder=wmalossless --enable-decoder=wmapro --enable-decoder=wmav1 --enable-decoder=wmav2 --enable-decoder=wmavoice --enable-decoder=xma1 --enable-decoder=xma2 --enable-decoder=adpcm_4xm --enable-decoder=adpcm_adx --enable-decoder=adpcm_afc --enable-decoder=adpcm_aica --enable-decoder=adpcm_ct --enable-decoder=adpcm_dtk --enable-decoder=adpcm_ea --enable-decoder=adpcm_ea_maxis_xa --enable-decoder=adpcm_ea_r1 --enable-decoder=adpcm_ea_r2 --enable-decoder=adpcm_ea_r3 --enable-decoder=adpcm_ea_xas --enable-decoder=adpcm_ima_amv --enable-decoder=adpcm_ima_apc --enable-decoder=adpcm_ima_dat4 --enable-decoder=adpcm_ima_dk3 --enable-decoder=adpcm_ima_dk4 --enable-decoder=adpcm_ima_ea_eacs --enable-decoder=adpcm_ima_ea_sead --enable-decoder=adpcm_ima_iss --enable-decoder=adpcm_ima_oki --enable-decoder=adpcm_ima_qt --enable-decoder=adpcm_ima_qt_at --enable-decoder=adpcm_ima_rad --enable-decoder=adpcm_ima_smjpeg --enable-decoder=adpcm_ima_wav --enable-decoder=adpcm_ima_ws --enable-decoder=adpcm_ms --enable-decoder=adpcm_mtaf --enable-decoder=adpcm_psx --enable-decoder=adpcm_sbpro_2 --enable-decoder=adpcm_sbpro_3 --enable-decoder=adpcm_sbpro_4 --enable-decoder=adpcm_swf --enable-decoder=adpcm_thp --enable-decoder=adpcm_thp_le --enable-decoder=adpcm_vima --enable-decoder=adpcm_xa --enable-decoder=adpcm_yamaha --enable-decoder=gremlin_dpcm --enable-decoder=interplay_dpcm --enable-decoder=pcm_alaw --enable-decoder=pcm_alaw_at --enable-decoder=pcm_bluray --enable-decoder=pcm_dvd --enable-decoder=pcm_f16le --enable-decoder=pcm_f24le --enable-decoder=pcm_f32be --enable-decoder=pcm_f32le --enable-decoder=pcm_f64be --enable-decoder=pcm_f64le --enable-decoder=pcm_lxf --enable-decoder=pcm_mulaw --enable-decoder=pcm_mulaw_at --enable-decoder=pcm_s16be --enable-decoder=pcm_s16be_planar --enable-decoder=pcm_s16le --enable-decoder=pcm_s16le_planar --enable-decoder=pcm_s24be --enable-decoder=pcm_s24daud --enable-decoder=pcm_s24le --enable-decoder=pcm_s24le_planar --enable-decoder=pcm_s32be --enable-decoder=pcm_s32le --enable-decoder=pcm_s32le_planar --enable-decoder=pcm_s64be --enable-decoder=pcm_s64le --enable-decoder=pcm_s8 --enable-decoder=pcm_s8_planar --enable-decoder=pcm_u16be --enable-decoder=pcm_u16le --enable-decoder=pcm_u24be --enable-decoder=pcm_u24le --enable-decoder=pcm_u32be --enable-decoder=pcm_u32le --enable-decoder=pcm_u8 --enable-decoder=roq_dpcm --enable-decoder=sdx2_dpcm --enable-decoder=sol_dpcm --enable-decoder=xan_dpcm --enable-decoder=flv --enable-decoder=h264 --enable-decoder=vp6f --enable-decoder=flac --enable-decoder=hevc --enable-decoder=vp8 --enable-decoder=vp9 --enable-decoder='mpeg*' --enable-decoder='rv*' --enable-decoder='wmv*' --enable-decoder=msrle --enable-decoder='msmpeg4*' --enable-decoder=gif --enable-decoder=png --enable-decoder=mjpeg --enable-decoder=dvvideo --enable-decoder=theora --enable-decoder=vorbis --enable-decoder=dca --enable-libmfx --enable-decoder=h264_qsv --enable-decoder=ass --enable-decoder=srt --enable-decoder=ssa --enable-decoder=webvtt --enable-decoder=pgssub --enable-decoder=dvdsub --enable-decoder=text --disable-hwaccels --disable-muxers --enable-demuxers --enable-demuxer=aac --enable-demuxer=ac3 --enable-demuxer=amr --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=hevc --enable-demuxer=h264 --enable-demuxer=webm_dash_manifest --enable-demuxer=avi --enable-demuxer=rm --enable-demuxer=asf --enable-demuxer=image2 --enable-demuxer=dv --enable-demuxer=ogg --enable-demuxer=wtv --enable-demuxer=swf --enable-demuxer=mxf --enable-demuxer=gif --enable-demuxer=lrc --enable-demuxer=mp3 --enable-demuxer=flac --enable-demuxer=ape --enable-demuxer=wav --enable-demuxer=dts --enable-demuxer=dtshd --enable-demuxer=caf --enable-demuxer=iff --enable-demuxer=dsf --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --disable-bsf=eac3_core --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=concat --disable-protocol=crypto --disable-protocol=ffrtmpcrypt --disable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --disable-protocol=rtmp --disable-protocol=rtmpt --disable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=subfile --disable-protocol=unix --disable-devices --disable-filters --disable-iconv --disable-audiotoolbox --disable-sdl2 --disable-linux-perf --disable-bzlib --disable-zlib --arch=x86 --target-os=mingw32 --disable-static --enable-shared --enable-pic --enable-neon --enable-asm --disable-optimizations --enable-debug --disable-small --enable-cross-compile --pkg-config-flags=--static --enable-nonfree --enable-openssl --enable-libmfx --enable-decoder=h264_qsv --enable-demuxer=ass --enable-demuxer=webvtt --enable-demuxer=srt --cc= --extra-cflags=' -fno-stack-check ' --extra-cxxflags=' -fno-stack-check ' --extra-ldflags=' -static-libstdc++ '"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/d/Code/ijkplayer/shell/windows/../build/product/windows/ffmpeg-x86/share/ffmpeg"
#define AVCONV_DATADIR "/d/Code/ijkplayer/shell/windows/../build/product/windows/ffmpeg-x86/share/ffmpeg"
#define CC_IDENT "gcc 11.2.0 (Rev10, Built by MSYS2 project)"
